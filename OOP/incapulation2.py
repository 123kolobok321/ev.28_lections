...
#     @property
#     def number(self):
#         name = input('Vvedite svoe imya: ').lower().strip()
...
#     @x.setter
#     def x(self, value):
#         raise ChildProcessError('x coordinate is read-only field!')

#     @y.setter
#     def y(self, value):
#         raise ChildProcessError('y coordinate is read-only field!')
